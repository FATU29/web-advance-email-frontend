...
// Helper function outside component to avoid calling Date.now() during render
...
export function MessageInput({
  ...
  // Derive showInterruptPrompt: hide it when not generating
  const shouldShowInterruptPrompt = showInterruptPrompt && isGenerating;
  ...
  return (
    ...
    >
      {enableInterrupt && (
        <InterruptPrompt
          isOpen={shouldShowInterruptPrompt}
