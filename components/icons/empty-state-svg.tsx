    ...
    >
      ...
      <g filter={!isDarkTheme ? 'url(#filter1_dd_3099_2693)' : undefined}>
        <g clipPath={`url(#clip0_${isDarkTheme ? '2689_12764' : '3099_2693'})`}>
          ...
          {/* Envelope details */}
          <g
            clipPath={`url(#clip1_${isDarkTheme ? '2689_12764' : '3099_2693'})`}
          >
            <path
      ...
      <defs>
        ...
        >
          ...
          <stop
            offset="1"
            stopColor={paint0Stop1Color}
            stopOpacity={paint0Stop1Opacity}
          />
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop
            offset="1"
            stopColor={paint1Stop1Color}
            stopOpacity={paint1Stop1Opacity}
          />
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop
            offset="1"
            stopColor={paint2Stop1Color}
            stopOpacity={paint2Stop1Opacity}
          />
        </linearGradient>
        <linearGradient
...
export const EmptyStateIcon = ({
  ...
  // Default to dark theme (no theme switching needed)
  return <EmptyState width={width} height={height} className={className} />;
};
